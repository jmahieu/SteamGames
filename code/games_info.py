...
# Set file parameters
download_path = 'C:/Users/jeroe/Dropbox/SteamGames/data/'
steam_app_data = 'steam_app_data.csv'
steam_index = 'steam_index.txt'

steam_columns = [
    'type', 'name', 'steam_appid', 'required_age', 'is_free', 'controller_support',
    'dlc',  'short_description', 'fullgame', 'supported_languages', 
    'website',  'legal_notice', 'drm_notice', 'ext_user_account_notice',
    'developers', 'publishers', 'demos',  'packages', 'package_groups',
    'platforms', 'metacritic', 'categories', 'genres', 'recommendations', 'achievements', 
